...
namespace war
{
    ...
    class BattleField
    {
        ...
        private void Battle()
        {
            while (_redCountryPlatoon.GetCountOfSoldiers() > 0 && _blueCountryPlatoon.GetCountOfSoldiers() > 0)
            {
                ...
                _redCountryPlatoon.CheckSoldierHealth(_firstSoldier);
                _secondSoldier.TakeDamage(_firstSoldier.Damage);
                _blueCountryPlatoon.CheckSoldierHealth(_secondSoldier);
    ...
    class Platoon
    {
        ...
        public void CheckSoldierHealth(Soldier soldier)
        {
            if (soldier.Health <= 0)
            {
