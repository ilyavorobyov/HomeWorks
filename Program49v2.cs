...
namespace CarService
{
    ...
    class WareHouse
    {
        ...
        private void FillWithAutoParts()
        {
            for (int i = 0; i < _capacity; i++)
            {
                ...
                _autoParts.Add(_database.GetAutoPart(breakdownNumber));
            }
        }
    }
    ...
    class Database
    {
        ...
        public Database()
        {
            _autoParts.Add(new AutoPart("Двигатель", 1000));
            _autoParts.Add(new AutoPart("Аккумулятор", 500));
            _autoParts.Add(new AutoPart("Коробка передач", 700));
            _autoParts.Add(new AutoPart("Сцепление", 600));
        }
