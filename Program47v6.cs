...
namespace war
{
    ...
    class Platoon
    {
        ...
        {
            List<Soldier> soldiers = new List<Soldier> { new Sniper("Снайпер", 100, 60, 10), new Infantry("Пехота", 150, 40, 15), new HeavyInfantry("Тяжелая пехота", 200, 50, 20) };
            int minNumber = 0;
            int maxNumber = 3;
    ...
    class Soldier
    {
        ...
        {
            bool isUseSpecialAbility = CalculateProbabilityOfSpecialAbility();

            if (isUseSpecialAbility)
            {
                UseSpecialAbility();
            }
        ...
        public bool CalculateProbabilityOfSpecialAbility()
        {
            int number = 1;
            int maximumNumber = 5;
            int minimumNumber = 1;
