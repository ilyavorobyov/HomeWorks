...
namespace Zoo
{
    ...
    class Zoo
    {
        private EnclosureBuilder _enclosureBuilder = new EnclosureBuilder();
        ...
        private void ShowAllEnclosures()
        {
            ...
            foreach (AnimalEnclosure animalEnclosure in _enclosureBuilder.AnimalEnclosures)
            {
        ...
        private void ShowSelectedEnclosure()
        {
            ...
            else if (avairyNumber > 0 && avairyNumber <= _enclosureBuilder.AnimalEnclosures.Count)
            {
                _enclosureBuilder.AnimalEnclosures[avairyNumber - 1].ShowFullInfo();
            }
            else
            {
