...
namespace war
{
    ...
    class BattleField
    {
        ...
        private void Battle()
        {
            while (_redCountryPlatoon.GetCountOfSoldiers() > 0 && _blueCountryPlatoon.GetCountOfSoldiers() > 0)
            {
                ...
                _redCountryPlatoon.InquireSoldierIsAlive(_firstSoldier);
                _secondSoldier.TakeDamage(_firstSoldier.Damage);
                _blueCountryPlatoon.InquireSoldierIsAlive(_secondSoldier);
    ...
    class Platoon
    {
        ...
        public void InquireSoldierIsAlive(Soldier soldier)
        {
            if (soldier.Health <= 0)
            {
